...
### Análisis Textual con R y Python

**Fernando Díaz H., PhD.**
Departamento de Ingeniería Comercial — Universidad Técnica Federico Santa María (UTFSM) / Universidad del Pacífico

Versión 2026 &nbsp;|&nbsp; Contacto: [fernando.diaz@usm.cl](mailto:fernando.diaz@usm.cl) &nbsp;|&nbsp; [@fernando.diazh](https://twitter.com/fernando.diazh)
...
El material está disponible en el siguiente [repositorio](https://github.com/fdiaz1968/NLP); para obtener el código de fuente basta con que ejecutes el siguiente comando:

```
git clone https://github.com/fdiaz1968/NLP
```
...
📓 Notebook: [unit7_similitud_semantica.ipynb](unit7_similitud_semantica.ipynb)

## Metodología y Evaluación

El curso es eminentemente práctico. Cada unidad incluye un Jupyter Notebook (o script R Markdown) ejecutable en Google Colab o entorno local, con ejercicios guiados y un ejercicio de aplicación al final.
...
El **proyecto integrador** consiste en aplicar al menos tres de las técnicas del curso a un corpus de libre elección, documentando las decisiones metodológicas (incluyendo la justificación de herramienta) y comparando al menos un enfoque clásico con uno basado en LLM.
...
*Universidad Técnica Federico Santa María — [@fernando.diazh](https://twitter.com/fernando.diazh)*
